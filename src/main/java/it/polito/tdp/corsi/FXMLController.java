...
public class FXMLController {
    ...
    void stampaDivisione(ActionEvent event) {
    	...
    	if(codins == null || codins.equals("")) { //controllo sul formato dell'input
    		this.txtRisultato.setText("Inserisci codice insegnamento");
    		return;
    	}
    	//dovrei controllare che il corso esista
    	List<Divisione> risultato = this.model.getDivisioneStudenti(codins);
    	Collections.sort(risultato);
    	for(Divisione d : risultato) {
    		this.txtRisultato.appendText(d.getCDS()+"\t"+d.getN()+"\n");
    	}
    }
